...
export const DEFAULT_RESUME_CONTENT: ResumeContent = {
  ...
  projects: [
    ...
    },
    {
      ...
      description:
        "Digital business card platform co-founded with two other developers; built the frontend. Reached 100+ signups, wound down May 2026.",
      url: "https://konnecttaps.com",
    },
    {
