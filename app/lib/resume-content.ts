...
export const DEFAULT_RESUME_CONTENT: ResumeContent = {
  ...
  summary:
    "Computer Engineering graduate from York University with 7+ years of professional experience managing operations and co-founding a live product. Passionate about building software end-to-end — from frontend UI to backend infrastructure. Self-taught full-stack developer who ships real products.",
  experience: [
    {
      ...
      endDate: "Present",
      bullets: [
        "Co-founded a digital networking platform serving 100+ active users, teaching myself the full stack from scratch.",
  ...
  projects: [
    ...
    },
    {
      ...
      description:
        "Native macOS system manager with 11 tools for file organization, storage analysis, and optimization.",
      url: "",
    },
  ],
};
